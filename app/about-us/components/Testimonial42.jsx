        ...
        <div className="grid auto-cols-fr grid-cols-1 items-center gap-12 md:gap-16 lg:grid-cols-2 lg:gap-20">
          <div className="w-full max-w-md lg:mb-24">
            ...
            <p className="md:text-md">
              Real stories from buyers and sellers who found their way home
            </p>
          </div>
          <Carousel
            ...
            <CarouselContent>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "They walked me through the whole process from London. No
                    surprises, no games."
                  </blockquote>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Tendai verified the title deed himself. That alone made me
                    trust them."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">Zara Mupfumira</p>
                      <p>Property seller, Borrowdale</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "They explained the USD pricing clearly. No confusion about
                    what I was paying."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">David Chikwanda</p>
                      <p>First-time buyer, Mt Pleasant</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Chipo answered my WhatsApp at midnight. That's the service
                    you get here."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">Naledi Okonkwo</p>
                      <p>Investor, Avondale</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "They told me the borehole situation before I signed. Honest
                    people."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">Sipho Dlamini</p>
                      <p>Homeowner, Greendale</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Found the right property in three weeks. Fast,
                  ...
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    ...
                    <div>
                      <p className="font-semibold">Amara Hassan</p>
                      <p>Executive, Harare</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "They checked everything—solar, security, water. Saved me
                    from a bad deal."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">Themba Nkosi</p>
                      <p>Property investor, diaspora</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
