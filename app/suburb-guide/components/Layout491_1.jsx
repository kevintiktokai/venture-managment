    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Balanced</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Avondale, where growth meets stability
          </h1>
          <p className="md:text-md">
            Mixed residential and commercial energy. Good schools, strong rental
            demand, and the kind of infrastructure that supports both families
            and investors without breaking the bank.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Established neighbourhood with newer developments alongside
                  older estates. Properties range from USD 150,000 to USD
                  500,000. Young families and first-time investors find their
                  footing here.
                </p>
              </motion.div>
            </div>
