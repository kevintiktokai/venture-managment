      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            We don't guess. We live here, we work here, we verify everything.
          </p>
        </div>
        <div
              ...
              >
                <Fragment>
                  <div className="order-first flex flex-col justify-center p-6 md:p-8 lg:p-12 md:order-first">
                    ...
                    <p>
                      Our agents walk these streets weekly. We test water
                      pressure, inspect boreholes, verify security systems, and
                      talk to residents. Every suburb guide is built on real
