    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="eyebrow mb-3 md:mb-4">Value</p>
          <h1 className="mb-5 text-5xl font-light md:mb-6 md:text-7xl lg:text-8xl">
            Greendale, solid ground for smart buyers
          </h1>
          <p className="md:text-md">
            Established neighbourhood with lower entry prices and real
            appreciation potential. This is where budget-conscious buyers and
            savvy investors find opportunity without compromise.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Mix of older and renovated properties ranging from USD 80,000
                  to USD 300,000. Stands are generous, and many have been
                  improved with modern additions. Strong value relative to
                  comparable suburbs.
                </p>
              </motion.div>
            </div>
