        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">
              Newer developments, solar-ready stands, and a younger demographic
              building something fresh. This is where contemporary
              infrastructure meets genuine community.
            </p>
          ...
          >
            <div className="grid grid-cols-1 border border-border-primary md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                ...
                <p>
                  Properties range from USD 120,000 to USD 400,000. Stands are
                  designed for solar integration and water harvesting.
                  First-time buyers and young professionals dominate the market.
                </p>
