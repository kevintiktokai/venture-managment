    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="eyebrow mb-3 md:mb-4">Clarity</p>
          <h1 className="mb-5 text-5xl font-light md:mb-6 md:text-7xl lg:text-8xl">
            What our guides reveal about each suburb
          </h1>
          <p className="md:text-md">
            We address what matters most. Title deeds verified, infrastructure
            mapped, security assessed. No guesswork, no surprises.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Every property we feature has been checked for title validity
                  and legal standing. We've done the work so you don't have to
                  worry.
                </p>
              </motion.div>
            </div>
