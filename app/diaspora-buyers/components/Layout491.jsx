    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="eyebrow mb-3 md:mb-4">Security</p>
          <h1 className="mb-5 text-5xl font-light md:mb-6 md:text-7xl lg:text-8xl">
            How we protect your investment from fraud and uncertainty
          </h1>
          <p className="md:text-md">
            Buying property remotely means trusting the process. We've built
            ours on verification, transparency, and legal rigor. Every step is
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  We search the Deeds Office registry and verify ownership
                  history. Our legal team confirms no liens, disputes, or fraud
                  flags exist before you proceed.
                </p>
              </motion.div>
            </div>
            <div
