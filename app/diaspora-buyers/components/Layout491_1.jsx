    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Remote</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Buying safely from thousands of miles away
          </h1>
          <p className="md:text-md">
            Distance doesn't mean risk. We've built a system that protects you
            at every step, with legal safeguards and professional oversight.
          </p>
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8">
            <Button title="Understand" variant="secondary">
              Understand
            </Button>
            <Button
              title="More"
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  You can authorize us to act on your behalf for inspections and
                  legal matters. Our lawyers draft the agreement and explain
                  every clause.
                </p>
              </motion.div>
            </div>
